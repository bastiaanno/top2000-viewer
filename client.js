$(function() {
    ...
    socket.on('new song', function(msg) {
        ...
        setTimeout(function() {
            ...
            //if (createVotesText(msg.currentSong) !== '') playSound("bell_2x.mp3");
            ...
            if (msg.currentSong.hasOwnProperty('previous')) {
                ...
                if (msg.currentSong.previous === 0) {
                    ...
                    $('#current-song-difference').html('<img class="svg" src="ui-arrow-solid-new-blue.svg">');
    ...
    socket.on('editionSlogan', function(notification) {
        // $('#main-view').addClass('notification-shown');
        $('#topright').html("<span>" + notification + "</span>").delay(10000).fadeOut('slow');
    });
    ...
    socket.on('hour overview', function(msg) {
        ...
        $('#hour-overview-header').html('<b>' + msg.date + ' december ' + msg.hour + ':00 &nbsp;&nbsp;&nbsp;&nbsp; uur ' + msg.hourCount + '/' + msg.hoursTotal + '</b><br>' + msg.presenter);
